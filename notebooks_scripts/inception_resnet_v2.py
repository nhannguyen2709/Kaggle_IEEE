...
Concatenate(GlobalAvgPool, GlobalMaxPool) -> Dense(1024) -> BatchNormalization() -> Dropout(0.5) -> Dense(1024) -> BatchNormalization() -> Dropout(0.5) -> Dense(10)
...
def InceptionResNetV2(include_top=True,
    ...
    if include_top:
        ...
        if pooling == 'avg':
            ...
            x = Concatenate(axis=1)([x_avgpool, x_maxpool])
    ...
    x_newfc = Dense(1024, activation='relu', kernel_initializer='glorot_normal', name='dense_0')(x)
    x_newfc = BatchNormalization()(x_newfc)
    x_newfc = Dropout(0.5)(x_newfc)
    x_newfc = Dense(1024, activation='relu', kernel_initializer='glorot_normal', name='dense_1')(x_newfc)
    x_newfc = BatchNormalization()(x_newfc)
    x_newfc = Dropout(0.5)(x_newfc)
    x_newfc = Dense(10, activation='softmax', name='new_predictions')(x_newfc)
    model = Model(inputs, x_newfc, name='finetune-inception-resnet-v2')
